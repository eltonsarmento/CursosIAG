  <div class="rightpanel">
        ...
        <ul class="breadcrumbs">
            ...
            <li><a href="javascript:;">Painel do aluno</a> <span class="separator"></span></li>
        ...
        <div class="maincontent">
            <div class="maincontentinner">
                <div class="messagepanel">
                    <a href="/lms/aluno/duvidas/nova" class="btn btn-success btn-large">Criar nova dúvida</a>
                    </div><!--messagehead-->
                    <div class="messagemenu">
                        <ul>
                            <li class="back"><a><span class="iconfa-chevron-left"></span> Voltar</a></li>
                            <li {if $secao == 1} class="active" {/if}><a href="/lms/aluno/duvidas/listar/"><span class="iconfa-inbox"></span> Dúvidas</a></li>
                            <li {if $secao == 2} class="active" {/if}><a href="/lms/aluno/duvidas/excluidos/"><span class="iconfa-trash"></span> Lixeira</a></li>
                        </ul>
                    </div>
                    <div class="messagecontent">
                        ...
                        <div class="messageleft">
                            ...
                            <ul class="msglist">
                                ...
                                {else}
                                    ...
                                    <li {if $duvidaLateral.id == $duvida_selecionada} class="selected" {elseif $duvidaLateral.mensagem.lido == 0 && $duvidaLateral.mensagem.remetente_id != $usuario_id} class="unread" {/if}> 
                                        <a href="/lms/aluno/duvidas/listar/{$duvidaLateral.id}" style="text-decoration:none;">
                                            <div class="thumb"><img src="/lms/uploads/avatar/{$duvidaLateral.professor.avatar}" alt="" /></div>
                                            <div class="summary">
                                                <span class="date pull-right"><small>{$duvidaLateral.mensagem.data|date_format:"%d/%m/%Y"}</small></span>
                                                <h4>{$duvidaLateral.professor.nome}</h4>
                         ...
                         <div class="messageright">
                            ...
                            <div class="messageview">
                                ...
                                <div class="btn-group pull-right">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="/lms/aluno/duvidas/excluir/{$duvida.id}">Deletar Dúvida</a></li>
                                        {if $duvida.fechada == 0}
                            ...
                            <div class="msgreply">
                                <form action="/lms/aluno/duvidas/responder/{$duvida.id}" method="post"/>

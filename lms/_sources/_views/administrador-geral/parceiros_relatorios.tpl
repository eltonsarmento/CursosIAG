        ...
        <div class="pageheader">
         ...
         <div class="maincontent">
            <div class="maincontentinner">
                ...
                <a href="{$url_base}/lms/{$categoria}/parceiros/fecharMes" class="btn btn-warning btn-large" data-toggle="modal"><i class="iconfa-bar-chart"></i> Fechar relatório do mês</a><br /><br />


                <select name="parceiro_id" class="uniformselect" id="selectParceiro" onchange="mudarParceiro()">
                    <option value="" >Selecione uma opção</option>
                    <option value="">Todos</option>
                    {foreach item=parceiro from=$parceiros}
...
{literal}
<script type="text/javascript"> 
function mudarParceiro() {
    {/literal}
    window.location.href="{$url_site}lms/{$categoria}/parceiros/relatorio/" + jQuery('#selectParceiro').val();
    {literal}
}
</script>
{/literal}
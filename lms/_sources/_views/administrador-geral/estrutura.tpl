...
<div class="mainwrapper">
    ...
    <div class="header">
        <div class="logo">
            <a href="/lms/administrador-geral/dashboard/home"><img src="/lms/common/images/logo.png" alt="" /></a>
        </div>
                    ...
                    <div class="userloggedinfo">
                        ...
                        <div class="userinfo">
                            ...
                            <ul>
                                ...
                                <li><a href="/lms/administrador-geral/login/logout">Sair</a></li>
                            </ul>
                        </div>
                    </div>
                </li>
    ...
    <div class="leftpanel">
        ...
        <div class="leftmenu">        
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li {if $menu == 1} class="active" {/if}><a href="/lms/administrador-geral/dashboard/home"><span class="iconfa-laptop"></span> Principal</a></li>
                <li class="dropdown {if $menu == 2} active {/if}"><a href="#"><span class="iconfa-group"></span> Gerenciar Alunos</a>
                    <ul>
                        <li><a href="/lms/administrador-geral/alunos/novo">Cadastrar Aluno</a></li>
                        <li><a href="/lms/administrador-geral/alunos/listar">Todos os Alunos</a></li>
                        <li><a href="/lms/administrador-geral/depoimentos/listar">Gerenciar depoimentos</a></li>
                    </ul>
                </li>
                <li class="dropdown {if $menu == 3} active {/if}"><a href="#"><span class="iconfa-certificate"></span> Gerenciar Certificados</a>
                  <ul>
                      <li><a href="/lms/administrador-geral/certificados/relatorio">Relatórios de Certificados</a></li>
                  </ul>
                </li>
                <li class="dropdown {if $menu == 4} active {/if}"><a href="#"><span class="iconfa-user"></span> Gerenciar Professores</a>
                    <ul>
                        <li><a href="/lms/administrador-geral/professores/novo">Cadastrar Professor</a></li>
                        <li><a href="/lms/administrador-geral/professores/listar">Todos os Professores</a></li>
                        <li><a href="/lms/administrador-geral/professores/estatisticas">Estatísticas</a></li>
                        <li><a href="/lms/administrador-geral/professores/pagamentos">Gerenciar Pagamentos</a></li>
                    </ul>
                </li>
                
                <li class="dropdown {if $menu == 5} active {/if}"><a href="#"><span class="iconfa-briefcase"></span> Gerenciar Parceiros</a>
                    <ul>
                        <li><a href="/lms/administrador-geral/parceiros/novo">Cadastrar Parceiro</a></li>
                        <li><a href="/lms/administrador-geral/parceiros/listar">Gerenciar Parceiro</a></li>
                        <li><a href="/lms/administrador-geral/parceiros/relatorio">Relatórios de vendas</a></li>
                        <li><a href="/lms/administrador-geral/parceiros/comprovante">Repasses Financeiros</a></li>
                    </ul>
                </li>
                
                <li class="dropdown {if $menu == 6} active {/if}"><a href="#"><span class="iconfa-money"></span> Gerenciar Administrativo</a>
                    <ul>
                        <li><a href="/lms/administrador-geral/administrativos/novo">Cadastrar Usuário</a></li>
                        <li><a href="/lms/administrador-geral/administrativos/listar">Todos os Usuários</a></li>
                        <li><a href="/lms/administrador-geral/cupons/listar">Gerenciar Cupons</a></li>
                    </ul>
                </li>

                <li class="dropdown {if $menu == 14} active {/if}"><a href="#"><span class="iconfa-cogs"></span> Gerenciar Categorias</a>
                    <ul>
                        <li><a href="/lms/administrador-geral/categorias/listar"> Todas as Categorias</a></li>
                        <li><a href="/lms/administrador-geral/categorias/nova"> Nova Categoria</a></li>
                    </ul>
                </li>
                
                <li class="dropdown {if $menu == 7} active {/if}"><a href="#"><span class="iconfa-book"></span> Gerenciar Cursos</a>
                    <ul>
                        <li><a href="/lms/administrador-geral/curso/novo">Cadastrar Cursos/Produtos</a></li>
                        <li><a href="/lms/administrador-geral/curso/listar">Todos os Cursos</a></li>
                    </ul>
                </li>

                <li class="dropdown {if $menu == 15} active {/if}"><a href="#"><span class="iconfa-tasks"></span> Canto do Empreendedor</a>
                  <ul>
                      <li><a href="/lms/administrador-geral/empreendedor/listar">Listar</a></li>
                      <li><a href="/lms/administrador-geral/empreendedor/novo">Cadastrar</a></li>
                    </ul>
                </li>

                <li class="dropdown {if $menu == 8} active {/if}"><a href="#"><span class="iconfa-reorder"></span> Gerenciar Planos</a>
                  <ul>
                      <li><a href="/lms/administrador-geral/planos/listar">Todos os Planos</a></li>
                      <li><a href="/lms/administrador-geral/planos/novo">Adicionar Plano</a></li>
                    </ul>
                </li>
                
                <li class="dropdown {if $menu == 9} active {/if}"><a href="#"><span class="iconfa-bar-chart"></span> Gerenciar Vendas</a>
                    <ul>
                        <li><a href="/lms/administrador-geral/vendas/nova">Nova Venda</a></li>
                        <li><a href="/lms/administrador-geral/vendas/relatorio">Relatórios de Vendas</a></li>
                    </ul>
                </li>

                <li class="dropdown {if $menu == 10} active {/if}"><a href="#"><span class="iconfa-exclamation"></span> Gerenciar Notificações</a>
                  <ul>
                      <li><a href="/lms/administrador-geral/notificacoesadmin/nova">Nova Notificação</a></li>
                      <li><a href="/lms/administrador-geral/notificacoesadmin/listar">Todas as Notificações</a></li>
                    </ul>
                </li>

                <li class="dropdown {if $menu == 11} active {/if}"><a href="#"><span class="iconfa-user"></span> Gerenciar Administrador</a>
                  <ul>
                      <li><a href="/lms/administrador-geral/administradores/novo">Cadastrar Administrador</a></li>
                      <li><a href="/lms/administrador-geral/administradores/listar">Todos os Administradores</a></li>
                    </ul>
                </li>

                <li class="dropdown {if $menu == 12} active {/if}"><a href="#"><span class="iconfa-group"></span> Gerenciar Coordenadores</a>
                  <ul>
                      <li><a href="/lms/administrador-geral/coordenadores/novo">Cadastrar Coordenador</a></li>
                      <li><a href="/lms/administrador-geral/coordenadores/listar">Todos os Coordenadores</a></li>
                    </ul>
                </li>
                <li class="dropdown {if $menu == 14} active {/if}"><a href="#"><span class="iconfa-group"></span> Gerenciar Coordenador Parceiro</a>
                  <ul>
                      <li><a href="/lms/administrador-geral/coordenadorparceiros/novo">Cadastrar Coordenador Parceiro</a></li>
                      <li><a href="/lms/administrador-geral/coordenadorparceiros/listar">Todos os Coordenadores Parceiros</a></li>
                    </ul>
                </li>
                
                <li class="dropdown {if $menu == 13} active {/if}"><a href="#"><span class="iconfa-cogs"></span> Configurações Gerais</a>
                    <ul>
                        <li><a href="/lms/administrador-geral/configuracoesgerais/produtos">Variações de Produtos</a></li>
                        <li><a href="/lms/administrador-geral/emails/listar">Modelos de E-mails</a></li>
                        <li><a href="/lms/administrador-geral/configuracoesgerais/termos">Termos e Condições</a></li>
                        <li><a href="/lms/administrador-geral/configuracoesgerais/pagamentos">Configurações de Pagamento</a></li>
                        <li><a href="/lms/administrador-geral/configuracoesgerais/imagens">Configurações de Imagens</a></li>
                        <li><a href="/lms/administrador-geral/configuracoesgerais/certificados">Configurações do Certificado</a></li>
                        <li><a href="/lms/administrador-geral/configuracoesgerais/servidores">Servidor</a></li>
                        <li><a href="/lms/administrador-geral/configuracoesgerais/graficas">Gráfica</a></li>
                    </ul>
                </li>
                
                <li><a href="/lms/administrador-geral/login/logout"><span class="iconfa-signout"></span> Sair</a></li>

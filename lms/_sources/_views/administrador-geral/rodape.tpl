...
function alterarSenha() {
	{/literal}
	jQuery.post('/lms/administrador-geral/perfil/trocarSenha', jQuery('#formSenha').serialize(), function html(html) {ldelim} jQuery('#resposta_trocar_senha').html(html); {rdelim});
	{literal}
}

...
<div class="mainwrapper">
    ...
    <div class="header">
        <div class="logo">
            <a href="/lms/administrativo/dashboard/home"><img src="/lms/common/images/logo.png" alt="" /></a>
        </div>
            ...
            <ul class="headmenu">
                ...
                <li>
                    ...
                    <ul class="dropdown-menu newusers">
                        ...
                        <li>
                            <a href="/lms/administrativo/notificacoes/listar/{$notificacao.id}">
                        ...
                        {/foreach}
                        <li><a href="/lms/administrativo/notificacoes/listar">VER TODAS NOTIFICAÇÕES</a></li>
                    </ul>
                </li>
                    ...
                    <div class="userloggedinfo">
                        ...
                        <div class="userinfo">
                            ...
                            <ul>
                                ...
                                <li><a href="/lms/administrativo/login/logout">Sair</a></li>
                            </ul>
                        </div>
                    </div>
                </li>
    ...
    <div class="leftpanel">
        ...
        <div class="leftmenu">
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li {if $menu == 1} class="active" {/if}><a href="/lms/administrativo/dashboard/home"><span class="iconfa-laptop"></span> Principal</a></li>
                <li class="dropdown{if $menu == 2} active {/if}"><a href=""><span class="iconfa-tasks"></span> Painel Administrativo</a>
                	<ul>
                    	<li><a href="/lms/administrativo/vendas/pedidos">Pedidos/Vendas</a></li>
                        <li><a href="/lms/administrativo/alunos/listar">Consultar Alunos</a></li>
                        <li><a href="/lms/administrativo/certificados/relatorio">Gerenciar Certificados</a></li>
                        <li><a href="/lms/administrativo/cupons/listar">Gerenciar Cupons</a></li>
						<li><a href="/lms/administrativo/cupons/relatorio">Relatórios de Cupons</a></li>
                    </ul>
                </li>
                
                <li><a href="/lms/administrativo/login/logout"><span class="iconfa-signout"></span> Sair</a></li>

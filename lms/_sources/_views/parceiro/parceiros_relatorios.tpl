        ...
        <div class="pageheader">
         ...
         <div class="maincontent">
            <div class="maincontentinner">
                ...
                <a href="#myModal2" class="btn btn-warning btn-large" data-toggle="modal"><i class="iconfa-bar-chart"></i> Comprovante</a><br /><br />
...
<div aria-hidden="false" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" class="modal hide fade in" id="myModal2">
    ...
    <div class="modal-body">
        ...
        <form action="" method="post" id="formComprovante" onsubmit="return false;" enctype="multipart/data-form">
            
            <input type="hidden" value="1" name="enviar"/>
            <div id="resposta_enviar_comprovante"></div>

            <h4>Mês</h4>
            <p class="margintop10">
                <span class="formwrapper">

                    <span class="field"><input type="text" name="data" id="data_modal" class="input-small" onblur="mudarPreco();" placeholder="06/2013" /></span> 

                </span>
            </p>
        
            <p class="margintop10">Total: <strong id="resposta_dinheiro_modal">R$ </strong></p>
            ...
            <div class="par margintop10">
                ...
                <input type="file" name="comprovante" /></span>
            ...
            <p>
                ...
                <span class="field"><textarea cols="80" rows="5" name="observacao" class="span5"></textarea></span> 
            </p>
        

            <button class="btn btn-primary" onclick="enviarComprovante();">Enviar comprovante</button>
...
function mudarPreco() {
    {/literal}
    jQuery.post('/lms/parceiro/parceiros/calcularQuantoRetornar', {ldelim}data: jQuery('#data_modal').val(){rdelim}, function html(html) {ldelim} jQuery('#resposta_dinheiro_modal').html(html); {rdelim});
    {literal}
}
...
function enviarComprovante() {
    var options = { 
        ...
        resetForm:  true,
        type:       'post',
        url:        '/lms/parceiro/parceiros/enviarComprovante'
    };
    jQuery('#formComprovante').ajaxSubmit(options); 
    return false;
}

function resposta(retorno) {
   jQuery('#resposta_enviar_comprovante').html(retorno); 
}
</script>
{/literal}
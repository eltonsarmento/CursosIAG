...
<div class="mainwrapper">
    ...
    <div class="header">
        <div class="logo">
            <a href="/lms/parceiro/dashboard/home"><img src="/lms/common/images/logo.png" alt="" /></a>
        </div>
            ...
            <ul class="headmenu">
                ...
                <li>
                    ...
                    <ul class="dropdown-menu newusers">
                        ...
                        <li>
                            <a href="/lms/parceiro/notificacoes/listar/{$notificacao.id}">
                        ...
                        {/foreach}
                        <li><a href="/lms/parceiro/notificacoes/listar">VER TODAS NOTIFICAÇÕES</a></li>
                    </ul>
                </li>
                    ...
                    <div class="userloggedinfo">
                        ...
                        <div class="userinfo">
                            ...
                            <ul>
                                ...
                                <li><a href="/lms/parceiro/login/logout">Sair</a></li>
                            </ul>
                        </div>
                    </div>
                </li>
    ...
    <div class="leftpanel">
        ...
        <div class="leftmenu">        
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li {if $menu == 1} class="active" {/if}><a href="/lms/parceiro/dashboard/home"><span class="iconfa-laptop"></span> Principal</a></li>
                <li class="dropdown {if $menu == 2} active {/if}"><a href=""><span class="iconfa-tasks"></span> Painel Parceiro</a>
                	<ul>
                    	<li><a href="/lms/parceiro/alunos/listar">Gerenciar Alunos</a></li>
                        <li><a href="/lms/parceiro/vendas/pedidos">Gerenciar Vendas</a></li>
                        <li><a href="/lms/parceiro/vendas/nova">Fazer Venda</a></li>
                        <li><a href="/lms/parceiro/parceiros/relatorio">Relatórios de Vendas</a></li>
                        <li><a href="/lms/parceiro/parceiros/comprovante">Comprovantes Enviados</a></li>
                    </ul>
                </li>
                
                <li><a href="/lms/parceiro/login/logout"><span class="iconfa-signout"></span> Sair</a></li>

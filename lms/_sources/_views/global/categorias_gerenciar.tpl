    ...
    <div class="rightpanel">
        ...
        <div class="maincontent">
            <div class="maincontentinner">
                ...
                <a href="/lms/{$modulo}/categorias/nova" class="btn btn-success"><i class="iconfa-plus"></i> ADICIONAR NOVA CATEGORIA</a>
                ...
                <table class="table table-bordered responsive" id="dyntable">
                    <thead>
                        <tr>
                            ...
                            <th class="head1 center">Exibir</th>
                        ...
                        <tr>
                            ...
                            <td width="90">
                            	...
                            	<ul class="tooltipsample">
                                	<li><a href="/lms/{$modulo}/categorias/editar/{$categoria.id}" class="btn" data-placement="bottom" data-rel="tooltip" data-original-title="Editar Categoria"><i class="iconfa-pencil"></i></a></li>
                ...
                <a href="/lms/{$categoria}/categorias/nova" class="btn btn-success"><i class="iconfa-plus"></i> ADICIONAR NOVA CATEGORIA</a>

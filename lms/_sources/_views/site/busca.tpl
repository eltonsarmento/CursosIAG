        <section class="container">
            <section class="category-title">
                <section class="category-title-content">
                    <h1>Resultado(s) pela busca: {$palavraChave}</h1>
            ...
            <section class="category-info">
                ...
                <section class="order-view">
                    <form>
                        ...
                        <select name="ordenar" id="selectOrdenacao" onchange="mudarOrdenacao();">
...
<!-- FORM BUSCA -->
<form id="formBusca" action="{$url_site}curso/buscar" method="post">
    <input type="hidden" name="palavras" value="{$palavraChave}"/>

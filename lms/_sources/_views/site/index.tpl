        ...
        <section class="container">
            <section class="cursos-content">
                {foreach item=curso from=$cursosDestaque}
                    ...
                    <article>
                        <figure><a href="{$url_site}curso/{$curso.url}"><img itemprop="image" src="{$url_site}lms/uploads/imagens/{$curso.destaque_arquivo}" title="{$curso.curso}" alt="{$curso.curso}"></a></figure>
                        <h2 style="display:none;">
                            {foreach item=categoria from=$curso.categorias}
                                {$categoria.categoria}
                            {/foreach}
                        ...
                        <section class="box-cursos-content">
                            <a href="{$url_site}curso/{$curso.url}"><h1 itemprop="name">{$curso.curso}</h1></a>
                            <section class="info-curso">
                                <span>Curso Online</span>
                            </section><!--.info-cursos-->

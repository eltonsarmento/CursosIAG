        <section class="container">
            ...
            <section class="page">
                ...
                <section class="page-content">
                    ...
                    <p>Acesse seu painel de aluno <a href="{$url_site}lms/" target="_blank">clicando aqui</a>, lá você poderá acompanhar o status da sua compra. Quando ela for APROVADA a liberação do acesso será AUTOMÁTICA.</p>

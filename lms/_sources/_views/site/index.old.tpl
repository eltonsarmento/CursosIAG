        ...
        <section class="banner-promocional">
            ...
            <section class="banner-content">
                ...
                <a href="http://cursosiag.com.br/pagina/promocao/" title="Promoção de Carnaval">
                    
                    <img src="{$url_site}lms/common/site/images/banners/carnaval-banner.png" alt="Lançamento da Carreira Youtuber">

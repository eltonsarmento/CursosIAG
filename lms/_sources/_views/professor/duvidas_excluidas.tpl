                            ...
                            <ul class="msglist">
                                ...
                                {else}
                                    ...
                                    <li {if $duvidaLateral.id == $duvida_selecionada} class="selected" {elseif $duvidaLateral.mensagem.lido == 0 && $duvidaLateral.mensagem.remetente_id != $usuario_id} class="unread" {/if}> 
                                        <a href="/lms/professor/duvidas/excluidos/{$duvidaLateral.id}" style="text-decoration:none;">
                            ...
                            <div class="messageview">
                                ...
                                <div class="btn-group pull-right">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="/lms/professor/duvidas/restaurar/{$duvida.id}">Restaurar Dúvida</a></li>
                                    </ul>
                                </div>

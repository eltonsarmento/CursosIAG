...
function alterarSenha() {
    {/literal}
    jQuery.post('/lms/coordenador-parceiro/perfil/trocarSenha', jQuery('#formSenha').serialize(), function html(html) {ldelim} jQuery('#resposta_trocar_senha').html(html); {rdelim});
    {literal}
}
</script>
<script>
  ...
  ga('create', 'UA-46041119-1', 'cursosiag.com.br');
  ga('send', 'pageview');

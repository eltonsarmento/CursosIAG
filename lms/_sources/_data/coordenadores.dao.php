...
class CoordenadoresDAO extends UsuariosDAO{
	...
	// ===============================================================
	public function getCoordenadores($palavra = '', $limit = '', $order = 'nome') {
		$query = $this->system->sql->select('*', 'usuarios', "excluido='0' and nivel = '2'" . ($palavra ? " and nome like '%" . $palavra . "%'" : ''), $limit, $order);

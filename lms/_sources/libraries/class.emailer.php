...
class Emailer {
	...
	var	$useragent		= "EmailParser";
	var	$mailpath		= "/usr/sbin/sendmail";	// Sendmail path
	var	$protocol		= "smtp";	// mail/sendmail/smtp
	var	$smtp_host		= "ssl://smtp.googlemail.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "naoresponda@cursosiag.com.br";		// SMTP Username
	var	$smtp_pass		= "PrivateEvent21";		// SMTP Password
	 ...
	 */
	public function __construct($config = array('starttls'  => true))
	{
		if (count($config) > 0)
		{

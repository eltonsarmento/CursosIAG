...
class Carrinho {
	...
	private function doConcluirGratuito() {
		...
		if ($vendaID) {
			...
			foreach ($produtos as $produto)  {
                ...
                $this->system->api->rdStation_lead('Curso gratuito - '.$produto['curso'], $form_data_array);
			}
	...
	protected function doConfirmacao() {	
		...
		$venda_id 	   = $this->system->session->getItem('venda_corrente');
		...
		if(!empty($boletoURL)){
			...
			$this->system->view->assign('numeroPedido', $venda_id);
		}
